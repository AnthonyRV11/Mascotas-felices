<%-- 
    Document   : frmVerFacturacionC
    Created on : 10-sep-2023, 13:33:48
    Author     : Anthony Rodriguez Valverde
--%>

<%@page import="java.util.List"%>
<%@page import="Entidades.FacturaCompra"%>
<%@page import="Logica.LNFacturaCompra"%>
            ...
            <table class="table">
                ...
                <tbody>
                    <%                        
                        ...
                        List<FacturaCompra> datos;
                        datos=logica.Listar("");
                        
                        for (FacturaCompra registro : datos) {
                    %>
                            <tr>
